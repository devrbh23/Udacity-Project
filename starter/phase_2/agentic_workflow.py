...
product_manager_evaluation_agent = EvaluationAgent(
    openai_api_key,
    "Product Manager Evaluation Agent",
    "The answer should follow: As a [user], I want [action] so that [benefit].",
...
program_manager_evaluation_agent = EvaluationAgent(
    ...
    "The answer should be product features structured as: Feature Name, Description, Key Functionality, User Benefit.",
...
development_engineer_evaluation_agent = EvaluationAgent(
    ...
    "Tasks must include: Task ID, Task Title, Related User Story, Description, Acceptance Criteria, Estimated Effort, Dependencies.",
...
routing_agent.agents = [
    {
        ...
        "description": "Creates user stories from product specs",
        "func": product_manager_support_function
    },
    {
        "name": "program manager",
        "description": "Groups stories into features",
        "func": program_manager_support_function
    },
    {
        "name": "development engineer",
        "description": "Creates development tasks from user stories",
